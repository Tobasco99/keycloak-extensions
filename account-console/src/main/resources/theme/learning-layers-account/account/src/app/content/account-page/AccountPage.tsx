...
export class AccountPage extends React.Component<AccountPageProps, AccountPageState> {
    ...
    private handleSubmit = (event: React.FormEvent<HTMLFormElement>): void => {
        ...
        if (isValid) {
            ...
            const validationMessages = Array.from(formData.keys()).reduce((acc: { [key: string]: string }, key) => {
                acc[key] = (form.elements.namedItem(key) as HTMLInputElement).validationMessage;
                return acc;
            }, {});
            this.setState({
